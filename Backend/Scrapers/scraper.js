...
export async function scrape(url, placeName) {
    console.log(`Scraping data for ${placeName}...`);
    ...
    console.log(`${placeName} - Puppeteer successfully launched...`);

    const page = await browser.newPage();
    await page.goto(url, { waitUntil: 'domcontentloaded' });

    console.log(`At ${placeName} page...`);
    ...
    console.log(`${placeName} - Scraped data...`);
